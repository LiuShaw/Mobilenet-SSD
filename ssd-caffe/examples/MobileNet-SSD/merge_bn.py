...
save_model = 'deploy/MobileNetSSD_deploy_2204.caffemodel' #Optional BUT: Where you want to save the deploy model. MAKE SURE THE DIRECTORY EXISTS BEFOREHAND. CREATE IT MANUALLY
...
if __name__ == '__main__':
    ...
    # pre_process(train_proto, deploy_proto)
